...
public class homework6 {
            ...
            if (kb.get(i).contains("=>")) {
                ...
                while (k < kb.get(i).length()) {
                    ...
                    if (j == kb.get(i).length())
                        break;
                    while (!Character.isDigit(kb.get(i).charAt(j)) && !Character.isLetter(kb.get(i).charAt(j))
                            && kb.get(i).charAt(j) != '~') {
                        j++;
                    }
                    k = j;
    ...
    // gives all the variable with their replacing values if unifiable, gives false
    // if cannot be unified
    // returns an empty arraylist if both are totaly equal and nothing needs to be
    // changed.
                ...
                for (Iterator<ArrayList<String>> itq = query.iterator(); itq.hasNext();) {
                    ...
                    for (Iterator<ArrayList<String>> its = sentence.iterator(); its.hasNext();) {
                        ...
                        if (query_literal.get(0).equals(sentence_literal.get(0))) {
                            ...
                            if ((query_literal.get(1).equals("true") && sentence_literal.get(1).equals("false"))
                                    || (query_literal.get(1).equals("false")
                                            && sentence_literal.get(1).equals("true"))) {
                                ...
                                if (unifyingValue.get(0).get(0) != "false") {
                                    ...
                                    if (unifyingValue.get(0).get(0) != "true") {
                                            ...
                                            if (!qc_literal.equals(query_literal)) {
                                                for (int x = 0; x < unifyingValue.size(); x++) {
                                                    for (int y = 2; y < qc_literal.size(); y++) {
                                                        // System.out.println(qc_literal.get(y)+"
                                                        // "+unifyingValue.get(x).get(0));
                                        ...
                                        for (Iterator<ArrayList<String>> itsc = sentencecopy.iterator(); itsc
                                                .hasNext();) {
    ...
    public static void main(String[] args) {
        ...
        // reading the input from the text file and storing the queries and the kb in an
        // ArrayList.
        try {
