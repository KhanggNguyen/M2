 ...
 * @generated
 */
public class ProcessusSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProcessusPackage.PROCESS: {
				processus.Process process = (processus.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProcessusPackage.ACTIVITY: {
				Activity activity = (Activity)theEObject;
				T result = caseActivity(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProcessusPackage.PSEUDO_STATE: {
				PseudoState pseudoState = (PseudoState)theEObject;
				T result = casePseudoState(pseudoState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProcessusPackage.INIT: {
	 ...
	 * @generated
	 */
	public T caseProcess(processus.Process object) {
		return null;
	}
