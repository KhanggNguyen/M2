        ...
        if(!(m.getCode() == null) && !(m.getCode().length() == 0)) {
            ...
            try{
                ...
                for(String pays : m.pays){
                    ...
                    statement.setString(3, m.getCode());
                    statement.executeUpdate();
                }
