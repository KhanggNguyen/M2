...
public class MaquettePackageImpl extends EPackageImpl implements MaquettePackage {
	...
	public static MaquettePackage init() {
		if (isInited)
			return (MaquettePackage) EPackage.Registry.INSTANCE.getEPackage(MaquettePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMaquettePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MaquettePackageImpl theMaquettePackage = registeredMaquettePackage instanceof MaquettePackageImpl
				? (MaquettePackageImpl) registeredMaquettePackage
				: new MaquettePackageImpl();
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFormation_NbSemestres(), ecorePackage.getEInt(), "nbSemestres", null, 0, 1, Formation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFormation_Semestres(), this.getSemestre(), null, "semestres", null, 0, -1, Formation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFormation_CompétencesEnseignées(), this.getCompétence(), null, "compétencesEnseignées", null,
				0, -1, Formation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFormation_UesPotentielles(), this.getUE(), null, "uesPotentielles", null, 0, -1,
		...
		initEClass(semestreEClass, Semestre.class, "Semestre", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSemestre_Numero(), ecorePackage.getEInt(), "numero", null, 0, 1, Semestre.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSemestre_NbECTS(), ecorePackage.getEInt(), "nbECTS", "30", 0, 1, Semestre.class,
		...
		initEAttribute(getUE_Nom(), ecorePackage.getEString(), "nom", null, 0, 1, maquette.UE.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUE_NbECTS(), ecorePackage.getEInt(), "nbECTS", null, 0, 1, maquette.UE.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUE_Compétence(), this.getCompétence(), this.getCompétence_Ues(), "compétence", null, 0, -1,
				maquette.UE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUE_Disciplinaire(), ecorePackage.getEBoolean(), "disciplinaire", "true", 0, 1,
				maquette.UE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(compétenceEClass, Compétence.class, "Compétence", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCompétence_Nom(), ecorePackage.getEString(), "nom", null, 0, 1, Compétence.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCompétence_Description(), ecorePackage.getEString(), "description", null, 0, 1,
				Compétence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getCompétence_Ues(), this.getUE(), this.getUE_Compétence(), "ues", null, 0, -1, Compétence.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(formationsEClass, Formations.class, "Formations", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFormations_Formations(), this.getFormation(), null, "formations", null, 0, -1,
				Formations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
