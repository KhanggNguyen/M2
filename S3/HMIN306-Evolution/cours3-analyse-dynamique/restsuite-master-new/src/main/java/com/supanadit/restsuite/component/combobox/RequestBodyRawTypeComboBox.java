...
public class RequestBodyRawTypeComboBox extends JComboBox<BodyRawTypeModel> {
    ...
    public void setType(String type) {
        analyse.AnalyseLog.analyseLog( "setType", "getBodyRawTypeModels");
    ...
    public String toString() {
        analyse.AnalyseLog.analyseLog( "toString", "getName");
        analyse.AnalyseLog.analyseLog( "toString", "getSelectedItem");
