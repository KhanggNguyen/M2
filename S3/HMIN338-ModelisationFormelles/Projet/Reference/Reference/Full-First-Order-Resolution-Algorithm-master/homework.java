...
public class homework {
    ...
    public static boolean dfs_function(Stack<String> querystack, int counterInfinite) {
        ...
        while (!querystack.isEmpty()) {
            /*
             * if(querystack.isEmpty()) { return true; }
             */
            ...
            // FOR SEARCHING IN KB
            /*
             * if(pred.contains("~")) pred=pred.substring(1); else pred="~"+pred;
             */
                        ...
                        for (int m = 0; m < ored.size(); m++) {
                            ...
                            while (it.hasNext()) {
                                ...
                                if (currentkbelement.contains((String) pair.getKey()))
                                    currentkbelement = currentkbelement.replace((String) pair.getKey(),
                             ...
                             * System.out.println("i am inside if loop"); copystack.push(currentkbelement);
    ...
    public static void main(String[] args) throws IOException {
        ...
        /*
         * System.out.println("querysize"+querysize); System.out.println("query"+query);
        ...
        for (int k = 0; k < givenkb.size(); k++) {
            ...
            // System.out.println("prefix before distributivity
            // "+startingpartdistr_prefixing);
        ...
        for (int k = 0; k < kblist.size(); k++) {
            ...
            while (it.hasNext()) {
                ...
                // newtrying = newtrying.replace(pair.getKey().toString(),
        ...
        /*
         * for(int k=0;k<kblist2.size();k++) { String w = kblist2.get(k);
         * 
         * for (int i = 0; i < w.length(); i++) {
         * 
         * if (w.charAt(i) >= 'A' && w.charAt(i) <= 'Z') { if (i - 1 != -1) { if
         * (w.charAt(i - 1) == '~') { String pred = "~"; int checkconstant = 0; while
         * (w.charAt(i) != '(') { if (w.charAt(i) == ','|| w.charAt(i)==')') {
         * checkconstant = 1; break; } pred += w.charAt(i) + ""; i++; } if
         * (checkconstant == 0) { if(storekbhmap.containsKey(pred)) { ArrayList<String>
         * temper=storekbhmap.get(pred); temper.add(w); storekbhmap.remove(pred);
         * storekbhmap.put(pred,temper); } else { ArrayList<String> temp = new
         * ArrayList<String>(); temp.add(w); storekbhmap.put(pred, temp); } } } else {
         * System.out.println("hi im here"); String pred = ""; int checkconstant = 0;
         * while (w.charAt(i) != '(') { if (w.charAt(i) == ',' || w.charAt(i)==')') {
         * checkconstant = 1; break; } pred += w.charAt(i) + ""; i++; } if
         * (checkconstant == 0) { if(storekbhmap.containsKey(pred)) { ArrayList<String>
         * temper=storekbhmap.get(pred); temper.add(w); storekbhmap.remove(pred);
         * storekbhmap.put(pred,temper); } else { ArrayList<String> temp = new
         * ArrayList<String>(); temp.add(w); storekbhmap.put(pred, temp); } } } } else {
         * String pred = ""; int checkconstant = 0; while (w.charAt(i) != '(') { if
         * (w.charAt(i) == ',') { checkconstant = 1; break; } pred += w.charAt(i) + "";
         * i++; } if (checkconstant == 0) { if(storekbhmap.containsKey(pred)) {
         * ArrayList<String> temper=storekbhmap.get(pred); temper.add(w);
         * storekbhmap.remove(pred); storekbhmap.put(pred,temper); } else {
         * ArrayList<String> temp = new ArrayList<String>(); temp.add(w);
         * storekbhmap.put(pred, temp); } } } }
         * 
         * 
         * } }
        ...
        /*
         * Stack<String> querystack=new Stack<String>(); counterInfinite=0; String
         * querytp="~Child(Scrooge)"; querytp=querytp.replace(" ","");
         * if(querytp.contains("~")) querytp=querytp.substring(1); else
         * querytp="~"+querytp; querystack.push(querytp); boolean
         * res=dfs_function(querystack,counterInfinite);
         * 
         * if (res == true) { //answers.add("TRUE");
         * System.out.println("the answer is TRUE");
         * 
         * } else { // answers.add("FALSE"); System.out.println("the answer is FALSE");
         * }
         */
