...
public class UEItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UE_nom_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UE_nom_feature", "_UI_UE_type"),
						MaquettePackage.Literals.UE__NOM, true, false, false,
	...
	protected void addNbECTSPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MaquettePackage.Literals.UE__NB_ECTS, true, false, false,
	...
	protected void addCompétencePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UE_compétence_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UE_compétence_feature", "_UI_UE_type"),
						MaquettePackage.Literals.UE__COMPÉTENCE, true, false, true, null, null, null));
	}
	...
	protected void addDisciplinairePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UE_disciplinaire_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UE_disciplinaire_feature", "_UI_UE_type"),
						MaquettePackage.Literals.UE__DISCIPLINAIRE, true, false, false,
