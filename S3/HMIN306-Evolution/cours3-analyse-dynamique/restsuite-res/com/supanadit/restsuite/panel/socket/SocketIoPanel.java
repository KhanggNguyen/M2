...
public class SocketIoPanel extends JPanel {
    ...
    public void reloadSocketListener() {
        if (socket != null) {
            analyse.AnalyseLog.analyseLog( "reloadSocketListener", "getDataVector");
            analyse.AnalyseLog.analyseLog( "reloadSocketListener", "getDataVector");
            listenerDefaultModel.getDataVector().forEach(( vector) -> {
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "hasListeners");
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                ...
                if (!socket.hasListeners(listener)) {
                    analyse.AnalyseLog.analyseLog( "reloadSocketListener", "on");
                    socket.on(listener, ( args) -> {
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "concat");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "concat");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "concat");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "append");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
                        analyse.AnalyseLog.analyseLog( "reloadSocketListener", "toString");
    ...
    public void deleteSelectedRowListener() {
        analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "getSelectedRow");
        if (!(listenerTable.getSelectedRow() < 0)) {
            analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "getSelectedRow");
            analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "removeRow");
            analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "getSelectedRow");
            analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "getValueAt");
            analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "getValueAt");
            ...
            if (socket != null) {
                analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "hasListeners");
                if (socket.hasListeners(deletedListener)) {
                    analyse.AnalyseLog.analyseLog( "deleteSelectedRowListener", "off");
    ...
    public void setStatus(boolean status) {
        analyse.AnalyseLog.analyseLog( "setStatus", "setEnabled");
        analyse.AnalyseLog.analyseLog( "setStatus", "setEnabled");
        isConnected = status;
        emitButton.setEnabled(isConnected);
        // It always be true
        ...
        if (isConnected) {
            analyse.AnalyseLog.analyseLog( "setStatus", "getButtonText");
            analyse.AnalyseLog.analyseLog( "setStatus", "setText");
            connectDisconnectButton.setText(getButtonText());
        } else if (socket != null) {
            analyse.AnalyseLog.analyseLog( "setStatus", "close");
            analyse.AnalyseLog.analyseLog( "setStatus", "getButtonText");
            analyse.AnalyseLog.analyseLog( "setStatus", "setText");
            connectDisconnectButton.setText(getButtonText());
            socket.close();
