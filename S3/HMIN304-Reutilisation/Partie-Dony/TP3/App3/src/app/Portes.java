...
public class Portes extends javax.swing.JPanel {
    ...
    private void porte2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_porte2MouseEntered
        Integer nbPlaces = porte2.getPlaces() + porte5.getPlaces() + porte6.getPlaces();
        jLabel1.setText(nbPlaces.toString());
    }//GEN-LAST:event_porte2MouseEntered

    private void porte5MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_porte5MouseEntered
        Integer nbPlaces = porte2.getPlaces() + porte5.getPlaces() + porte6.getPlaces();
        jLabel1.setText(nbPlaces.toString());
    }//GEN-LAST:event_porte5MouseEntered

    private void porte6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_porte6MouseEntered
        Integer nbPlaces = porte2.getPlaces() + porte5.getPlaces() + porte6.getPlaces();
        jLabel1.setText(nbPlaces.toString());
    }//GEN-LAST:event_porte6MouseEntered
