...
public class UEImpl extends MinimalEObjectImpl.Container implements UE {
	...
	public EList<Compétence> getCompétence() {
		if (compétence == null) {
			compétence = new EObjectWithInverseResolvingEList.ManyInverse<Compétence>(Compétence.class, this,
					MaquettePackage.UE__COMPÉTENCE, MaquettePackage.COMPÉTENCE__UES);
		}
		return compétence;
	}
	...
	public void setDisciplinaire(boolean newDisciplinaire) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaquettePackage.UE__DISCIPLINAIRE, oldDisciplinaire,
					disciplinaire));
	}
