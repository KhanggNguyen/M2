...
public class SemestreItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNumeroPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Semestre_numero_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Semestre_numero_feature",
								"_UI_Semestre_type"),
						MaquettePackage.Literals.SEMESTRE__NUMERO, true, false, false,
	...
	protected void addNbECTSPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Semestre_nbECTS_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Semestre_nbECTS_feature",
								"_UI_Semestre_type"),
						MaquettePackage.Literals.SEMESTRE__NB_ECTS, false, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addUesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Semestre_ues_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Semestre_ues_feature",
								"_UI_Semestre_type"),
						MaquettePackage.Literals.SEMESTRE__UES, true, false, true, null, null, null));
	}
