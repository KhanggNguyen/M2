...
public class RestPanel extends JPanel {
    ...
    public ImageIcon getIcon(String iconName) {
        analyse.AnalyseLog.analyseLog( "getIcon", "ImageIcon");
        analyse.AnalyseLog.analyseLog( "getIcon", "ImageIcon");
        analyse.AnalyseLog.analyseLog( "getIcon", "getClassLoader");
        analyse.AnalyseLog.analyseLog( "getIcon", "getClassLoader");
        analyse.AnalyseLog.analyseLog( "getIcon", "concat");
    ...
    public ImageIcon svgIcon(String iconName) throws IOException, TranscoderException {
        analyse.AnalyseLog.analyseLog( "svgIcon", "toString");
        analyse.AnalyseLog.analyseLog( "svgIcon", "convertSVGToPNG");
        analyse.AnalyseLog.analyseLog( "svgIcon", "getClassLoader");
        analyse.AnalyseLog.analyseLog( "svgIcon", "getClassLoader");
        analyse.AnalyseLog.analyseLog( "svgIcon", "concat");
