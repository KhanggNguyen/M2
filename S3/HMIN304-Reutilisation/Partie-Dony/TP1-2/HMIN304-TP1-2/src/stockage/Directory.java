...
{
	// pour la cohå±�ence interne du dossier, il est fondamental que la collection
	// de ses å››å£«ents soit inaccessible aux clients.
	...
	public void accept(Visitor v) {
		//Voir code page 338 de la description du pattern
		v.visitDirectory(this);
		for(ElementStockage es : elements) {
			es.accept(v);
		}
