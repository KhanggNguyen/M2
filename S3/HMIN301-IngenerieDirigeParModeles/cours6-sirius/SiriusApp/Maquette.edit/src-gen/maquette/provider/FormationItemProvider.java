 ...
 * @generated
 */
public class FormationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_nom_feature",
								"_UI_Formation_type"),
						MaquettePackage.Literals.FORMATION__NOM, true, false, false,
	...
	protected void addNbSemestresPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Formation_nbSemestres_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Formation_nbSemestres_feature",
								"_UI_Formation_type"),
						MaquettePackage.Literals.FORMATION__NB_SEMESTRES, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MaquettePackage.Literals.FORMATION__SEMESTRES,
				MaquetteFactory.eINSTANCE.createSemestre()));

		newChildDescriptors.add(createChildParameter(MaquettePackage.Literals.FORMATION__COMPÉTENCES_ENSEIGNÉES,
				MaquetteFactory.eINSTANCE.createCompétence()));

		newChildDescriptors.add(createChildParameter(MaquettePackage.Literals.FORMATION__UES_POTENTIELLES,
