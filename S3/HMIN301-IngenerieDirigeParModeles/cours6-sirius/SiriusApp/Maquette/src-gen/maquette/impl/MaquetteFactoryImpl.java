...
public class MaquetteFactoryImpl extends EFactoryImpl implements MaquetteFactory {
	...
	public static MaquetteFactory init() {
		try {
			MaquetteFactory theMaquetteFactory = (MaquetteFactory) EPackage.Registry.INSTANCE
					.getEFactory(MaquettePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case MaquettePackage.COMPÉTENCE:
			return createCompétence();
		case MaquettePackage.FORMATIONS:
			return createFormations();
		default:
