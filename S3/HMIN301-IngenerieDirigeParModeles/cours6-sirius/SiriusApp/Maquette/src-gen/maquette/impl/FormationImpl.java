...
public class FormationImpl extends MinimalEObjectImpl.Container implements Formation {
	...
	public void setNbSemestres(int newNbSemestres) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaquettePackage.FORMATION__NB_SEMESTRES,
					oldNbSemestres, nbSemestres));
	}
	...
	public EList<Semestre> getSemestres() {
		if (semestres == null) {
			semestres = new EObjectContainmentEList<Semestre>(Semestre.class, this,
					MaquettePackage.FORMATION__SEMESTRES);
		}
		return semestres;
	}
	...
	public EList<Compétence> getCompétencesEnseignées() {
		if (compétencesEnseignées == null) {
			compétencesEnseignées = new EObjectContainmentEList<Compétence>(Compétence.class, this,
					MaquettePackage.FORMATION__COMPÉTENCES_ENSEIGNÉES);
		}
	...
	public EList<UE> getUesPotentielles() {
		if (uesPotentielles == null) {
			uesPotentielles = new EObjectContainmentEList<UE>(UE.class, this,
					MaquettePackage.FORMATION__UES_POTENTIELLES);
		}
