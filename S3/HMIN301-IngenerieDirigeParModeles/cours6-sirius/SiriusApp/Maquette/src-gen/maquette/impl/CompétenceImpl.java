...
public class CompétenceImpl extends MinimalEObjectImpl.Container implements Compétence {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaquettePackage.COMPÉTENCE__DESCRIPTION,
	...
	public EList<UE> getUes() {
		if (ues == null) {
			ues = new EObjectWithInverseResolvingEList.ManyInverse<UE>(UE.class, this, MaquettePackage.COMPÉTENCE__UES,
					MaquettePackage.UE__COMPÉTENCE);
		}
		return ues;
	}
