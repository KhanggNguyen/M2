...
public class DAOFactory {
    private static final String FICHIER_PROPERTIES       = "dao.properties"; // ou bien "nom_du_package/dao.properties"
     ...
     * pour le moment)
     */
    public DAOMonnaie getDaoMonnaie() {
        return new DAOMonnaie(this);
    }
}
