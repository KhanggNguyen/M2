...
import mixin.generator.MyDslGenerator;
import mixin.parser.antlr.MyDslAntlrTokenFileProvider;
import mixin.parser.antlr.MyDslParser;
import mixin.parser.antlr.internal.InternalMyDslLexer;
import mixin.scoping.MyDslScopeProvider;
import mixin.serializer.MyDslSemanticSequencer;
import mixin.serializer.MyDslSyntacticSequencer;
import mixin.services.MyDslGrammarAccess;
import mixin.validation.MyDslConfigurableIssueCodesProvider;
import mixin.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "mixin/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("mixin.MyDsl");
	}
